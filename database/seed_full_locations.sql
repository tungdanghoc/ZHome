...
-- Xóa dữ liệu cũ và chuẩn hóa lại bảng locations
...
-- 2. 12 QUẬN NỘI THÀNH, 1 THỊ XÃ & 17 HUYỆN (Level 2)
INSERT INTO [dbo].[locations] ([id], [name], [type], [parent_id], [level]) VALUES 
...
(27, N'Huyện Thạch Thất', N'Huyện', 1, 2), -- KHU VỰC HÒA LẠC
...
-- 3. XÃ / PHƯỜNG CHI TIẾT (Level 3)
-- Xã thuộc Huyện Thạch Thất (Khu vực Hòa Lạc)
INSERT INTO [dbo].[locations] ([id], [name], [type], [parent_id], [level]) VALUES 
